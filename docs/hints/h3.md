...
<img class="elf_avatar" src="../../img/hints/h3/bushy_evergreen.png"/>
Provides a hint for [Windows Log Analysis - Evaluate Attack Outcome](../../challenges/c3/).
...
![Terminal](../img/hints/h3/h3_terminal.png)
