...
Jump to the [challenge solution](#challenge).
...
![Splunk 1](../img/challenges/c6/c6_1.png)
...
![Splunk 2](../img/challenges/c6/c6_2.png)

**Answer**: `C:\Users\cbanas\Documents\Naughty_and_Nice_2019_draft.txt` 

!!! note "Note"
    Interestingly the BASE64-encoded string found in the same Splunk event decodes to a PowerShell script that tries to disable [script block logging](https://docs.splunk.com/Documentation/UBA/5.0.0/GetDataIn/AddPowerShell), downloads encrypted data from http://144.202.46[.]214:8080/admin/get.php, decrypts it using an embedded key, and finally executes the decrypted data.
...
![Splunk 3](../img/challenges/c6/c6_3.png)
...
![Splunk 4](../img/challenges/c6/c6_4.png)
...
![Splunk 5](../img/challenges/c6/c6_5.png)
...
![Splunk 6](../img/challenges/c6/c6_6.png)
...
![Splunk 7](../img/challenges/c6/c6_7.png)
...
![Splunk 8](../img/challenges/c6/c6_8.png)
...
![Splunk 9](../img/challenges/c6/c6_9.png)
...
![Splunk 10](../img/challenges/c6/c6_10.png)
...
![Splunk 11](../img/challenges/c6/c6_11.png)
...
![Splunk 12](../img/challenges/c6/c6_12.png)

The embedded message reads: *"Kent you are so unfair. And we were going to make you the king of the Winter Carnival."*
